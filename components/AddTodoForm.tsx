...
export default function AddTodoForm() {
  ...
  return (
    <form ref={formRef} action={handleSubmit} className="mb-6 space-y-2">
      ...
      <input
        name="due_date"
        type="date"
        className="w-full px-4 py-2 rounded-xl bg-slate-800 border border-slate-700 text-slate-400 text-sm focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500 transition-colors"
      />
    </form>
  )
}